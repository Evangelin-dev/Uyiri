...
import { MessageCircle, Mail, Phone, MapPin, Clock, Sparkles, Send } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/contact" className="text-bright-pink underline underline-offset-4 font-medium">
                Contact
              </Link>
            </div>
